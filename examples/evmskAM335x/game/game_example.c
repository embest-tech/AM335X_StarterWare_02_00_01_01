...
//
//*****************************************************************************
tDisplay g_s35_480x272x24Display0;
tDisplay g_s35_480x272x24Display1;
...
main(void)
{
    ...
    GrOffScreen24BPPInit(&g_s35_480x272x24Display0, (unsigned char *)g_pucBuffer0, LCD_WIDTH, LCD_HEIGHT);
    GrOffScreen24BPPInit(&g_s35_480x272x24Display1, (unsigned char *)g_pucBuffer1, LCD_WIDTH, LCD_HEIGHT);

    // Initialize a drawing context.
    GrContextInit(&sContext0, &g_s35_480x272x24Display0);
    GrContextInit(&sContext1, &g_s35_480x272x24Display1);
    ...
    GrContextFontSet(&sContext0, &g_sFontCm14b);
    GrStringDrawCentered(&sContext0, "Play/Fire", -1, 50, 200, 0);
    GrContextForegroundSet(&sContext1, ClrRed);
    GrContextFontSet(&sContext1, &g_sFontCm14b);
    GrStringDrawCentered(&sContext1, "Play/Fire", -1, 50, 200, 0);
