...
MainScreen(void)
{
	...
	// if(ffIndex < 20)
		...
		CleanDSPCache_LCD();
                ...
                CacheDataCleanBuff((unsigned int)g_pucBuffer0, (unsigned int)(480*272*4) + 32);
                CacheDataCleanBuff((unsigned int)g_pucBuffer1, (unsigned int)(480*272*4) + 32);
    }
    ...
    while(1)
    {
        ...
        if(!bDead && !bAtExit)
        {
            ...
            else
            {
                ...
                if(bMoveMonsters)
                {
                    static unsigned int monstIdx = 0;
                    monstIdx++;
                    if(0 == (monstIdx % 5))
                    {
                        MoveMonsters();
